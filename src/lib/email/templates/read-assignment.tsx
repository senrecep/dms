...
interface ReadAssignmentEmailProps {
  userName: string;
...
export function ReadAssignmentEmail({
  userName,
  documentTitle,
  documentCode,
  publishedBy,
  readUrl,
  locale = "tr",
}: ReadAssignmentEmailProps) {
  const t = emailStrings[locale].readAssignment;
...
export default ReadAssignmentEmail;
